...
// создайте кнопку по добавлению на которую появляется создается и добавляется на страницу текст в теге h2

//добавьте кнопку которая бы изменяла стили этого текста, используйте классы

// для поиска элементов попробуйте использовать несколько разных методов!

// *добавьте третью кнопку которая имела бы возможность удалять текстовый элемент со страницы
